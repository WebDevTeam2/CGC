...
const Movies = () => {
  ...
  return (
    ...
    <Link
      ...
      className="relative clip-container group text-6xl justify-center flex lg:w-2/4 w-full h-screen overflow-hidden grayscale hover:grayscale-0 transition duration-500 ease-in-out cursor-pointer"
    >
      <Image
        src={batManImagePath}
