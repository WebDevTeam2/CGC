...
const Recommendations = ({ movieId }: { movieId: string }) => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="recommended-movies grid msm:grid-cols-2 msm:gap-3 msm:mx-auto md:grid-cols-3 lg:grid-cols-4 md:gap-4 msm:w-[26rem] md:w-3/4 lg:w-3/4 md:mr-auto md:ml-[10rem] lg:ml-[20rem] h-full not-search">
